...
IF NOT EXIST gen\NET_3.5_HFM_11.1.2.3 MKDIR gen\NET_3.5_HFM_11.1.2.3
IF NOT EXIST bin\NET_3.5_HFM_11.1.2.3 MKDIR bin\NET_3.5_HFM_11.1.2.3

ECHO Compiling HFMCmd...
C:\WINDOWS\Microsoft.NET\Framework\v3.5\csc.exe /nologo /target:exe /main:HFMCmd.Launcher /out:gen\NET_3.5_HFM_11.1.2.3\HFMCmd.exe /debug /optimize+ /define:HFM_11_1_2_3 /define:HFM_11_1_2_2 /define:HFM_11_1_2_2_300 /lib:lib\log4net-1.2.11\bin\net\3.5\release /reference:log4net.dll /lib:lib /reference:Interop.SCRIPTINGLib.dll /lib:lib/hfm-11.1.2.3 /reference:Interop.HFMCONSTANTSLib.dll /reference:Interop.HFMSLICECOMLib.dll /reference:Interop.HFMWAPPLICATIONSLib.dll /reference:Interop.HFMWDOCUMENTSLib.dll /reference:Interop.HFMWSESSIONLib.dll /reference:Interop.HSVCALCULATELib.dll /reference:Interop.HSVCDATALOADLib.dll /reference:Interop.HSVDATALib.dll /reference:Interop.HSVJOURNALLOADACVLib.dll /reference:Interop.HSVJOURNALSLib.dll /reference:Interop.HSVMETADATALOADACVLib.dll /reference:Interop.HSVMETADATALib.dll /reference:Interop.HSVPROCESSFLOWLib.dll /reference:Interop.HSVRESOURCEMANAGERLib.dll /reference:Interop.HSVRULESLOADACVLib.dll /reference:Interop.HSVSECURITYACCESSLib.dll /reference:Interop.HSVSECURITYLOADACVLib.dll /reference:Interop.HSVSESSIONLib.dll /reference:Interop.HSVSTARSCHEMAACMLib.dll /reference:Interop.HSVSYSTEMINFOLib.dll /reference:Interop.HSXCLIENTLib.dll /reference:Interop.HSXSERVERFILETRANSFERLib.dll /reference:Interop.HSXSERVERLib.dll /resource:gen\HFMCmd.Resource.Help.resources src\*.cs src\command\*.cs src\commandline\*.cs src\yaml\*.cs src\hfm\*.cs gen\*.cs gen/NET_3.5_HFM_11.1.2.3\*.cs
IF ERRORLEVEL 1 EXIT /B %ERRORLEVEL%

ECHO Bundling HFMCmd and libraries into HFMCmd.exe...
tools\ILMerge\ILMerge.exe  /wildcards /lib:C:\WINDOWS\Microsoft.NET\Framework\v3.5 /out:bin\NET_3.5_HFM_11.1.2.3\HFMCmd.exe gen\NET_3.5_HFM_11.1.2.3\HFMCmd.exe lib/hfm-11.1.2.3\*.dll lib\log4net-1.2.11\bin\net\3.5\release\log4net.dll lib\Interop.SCRIPTINGLib.dll
...
ECHO Compiling HFMCmd...
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\csc.exe /nologo /target:exe /main:HFMCmd.Launcher /out:gen\NET_4.0\HFMCmd.exe /debug /optimize+ /define:HFM_11_1_2_3 /define:HFM_11_1_2_2 /define:HFM_11_1_2_2_300 /define:LATE_BIND /lib:lib\log4net-1.2.11\bin\net\4.0\release /reference:log4net.dll  /lib:lib/hfm-11.1.2.3 /link:Interop.HFMCONSTANTSLib.dll /link:Interop.HSVSECURITYACCESSLib.dll /link:Interop.HSVSTARSCHEMAACMLib.dll /link:Interop.HSVCDATALOADLib.dll /link:Interop.HSVJOURNALLOADACVLib.dll /link:Interop.HSVMETADATALOADACVLib.dll /link:Interop.HSVSECURITYLOADACVLib.dll /resource:gen\HFMCmd.Resource.Help.resources src\*.cs src\command\*.cs src\commandline\*.cs src\yaml\*.cs src\hfm\*.cs gen\*.cs gen/NET_4.0\*.cs
IF ERRORLEVEL 1 EXIT /B %ERRORLEVEL%
